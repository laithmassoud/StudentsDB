...
router.get('/api/gender/:gender', student.findByGender);

router.get('/api/age/:age', student.findByAge);


router.get('/api/name/:name', student.findByName);




router.get('/api/student/subjects/:studentSubject', student.findSubject);
